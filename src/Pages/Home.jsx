...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col-reverse md:flex-row justify-center items-center min-h-screen p-2 md:p-12 gap-10">
        {/* Text Section */}
        <div className="w-full md:w-auto text-center md:text-left space-y-6 max-w-xl">
          ...
          <div className="flex md:flex-row gap-4 justify-center md:justify-start">
